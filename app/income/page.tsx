  ...
  const fetchData = async () => {
    try {
      ...
      if (categoriesResult.success) {
        setCategories(
          categoriesResult.data.filter((cat: Category) => cat.type === "income")
        );
      }
    } catch (error) {
  ...
  const handleDelete = async (transaction: Transaction) => {
    try {
      ...
      if (error.message) {
        ...
        } else if (error.message !== "ไม่สามารถลบรายการได้") {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        <div className="space-y-8 p-6">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-green-600/10 via-emerald-600/10 to-teal-600/10 rounded-2xl blur-3xl animate-pulse"></div>
            <div className="relative backdrop-blur-sm bg-white/70 dark:bg-slate-900/70 border border-white/20 dark:border-slate-800/20 rounded-2xl p-8">
              <div className="flex items-center justify-between">
                ...
                <div className="h-12 w-40 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl animate-pulse"></div>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="space-y-8 p-6">
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-r from-green-600/10 via-emerald-600/10 to-teal-600/10 rounded-2xl blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          <div className="relative backdrop-blur-sm bg-white/70 dark:bg-slate-900/70 border border-white/20 dark:border-slate-800/20 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-green-50/30 via-emerald-50/20 to-teal-50/30 dark:from-green-950/10 dark:via-emerald-950/5 dark:to-teal-950/10 rounded-2xl"></div>

            <div className="relative flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              <div className="flex items-center space-x-4">
                <div className="bg-gradient-to-br from-green-500 to-emerald-600 h-16 w-16 rounded-2xl flex items-center justify-center shadow-xl">
                  <TrendingUp className="h-8 w-8 text-white" />
                </div>
                <div>
                  <h1 className="text-4xl font-extrabold bg-gradient-to-r from-green-600 via-emerald-700 to-green-600 bg-clip-text text-transparent">
                    จัดการรายได้
                  </h1>
                  <div className="flex items-center space-x-4 mt-2">
                    ...
                    <div className="flex items-center space-x-2 bg-green-50/80 dark:bg-green-950/20 px-3 py-1 rounded-lg">
              ...
              <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
                <DialogTrigger asChild>
                  <Button className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 px-8 py-6 text-lg rounded-xl">
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-slate-600 dark:text-slate-300 mb-6">
                  {searchTerm || selectedCategory !== "all"
                    ...
                    : "เริ่มต้นการจัดการรายได้ของคุณวันนี้"}
                </p>
                {!searchTerm && selectedCategory === "all" && (
                  <Button
            ...
            {filteredTransactions.map((transaction, index) => {
              ...
              return (
                <div key={transaction.id} className="relative group">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-green-600/10 via-emerald-600/10 to-teal-600/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  ...
                  >
                    {/* Subtle gradient overlay */}
                    <div className="absolute inset-0 bg-gradient-to-br from-green-50/20 via-emerald-50/10 to-teal-50/20 dark:from-green-950/5 dark:via-emerald-950/3 dark:to-teal-950/5 rounded-2xl"></div>

                    <div className="relative p-6">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4 flex-1 min-w-0">
                          {/* Enhanced Icon */}
                          <div className="relative p-3 rounded-xl shadow-lg bg-gradient-to-br from-green-500 to-emerald-600 transition-all duration-300 group-hover:scale-110 group-hover:rotate-6">
                            <div className="absolute inset-0 rounded-xl bg-white/20 backdrop-blur-sm"></div>
                            <ArrowUpRight className="relative h-6 w-6 text-white drop-shadow-sm" />
                          </div>
                        ...
                        <div className="flex items-center gap-4 ml-4">
                          ...
                          <div className="text-right">
                            <div className="bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-950/30 dark:to-emerald-950/30 px-4 py-2 rounded-xl border border-green-200 dark:border-green-800/30">
                    ...
                    <div className="absolute top-2 right-2 w-12 h-12 bg-gradient-to-br from-green-400/10 to-emerald-400/10 rounded-full blur-lg"></div>
                    <div className="absolute bottom-2 left-2 w-8 h-8 bg-gradient-to-br from-teal-400/10 to-green-400/10 rounded-full blur-md"></div>
                  </div>
                </div>
              );
            })}
